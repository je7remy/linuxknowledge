...
- [[../3- hosts/index|3- hosts]] — protocolos sobre los que se inicia el shell.
- [[../4- privilege scalation/index|4- Escalación de privilegios]] — siguiente paso una vez con shell estable.
- [[../6- Web/1- Protocolo HTTP|6- Web → HTTP]] — vector del Web Shell.
- [[../../../01-Sistemas-Operativos/Linux/1- El Hacker Legendario 🐧🐍 - Fundamentos, Hacking y Certificaciones/3- Preparación para la Certificación del eJPTv2/2- Curso de Python Aplicado a la Ciberseguridad/14- Sockets/index|Python → 14- Sockets]] — implementar shells en Python con sockets.
