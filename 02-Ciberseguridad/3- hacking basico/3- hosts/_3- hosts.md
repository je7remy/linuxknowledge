...
- [[_1- Nmap|5- Reconocimiento → Nmap]] — herramienta usada para huella en cada nota.
- [[_1- Teoria de Ciberseguridad|1- Teoría de Ciberseguridad]] — base conceptual.
- [[_4- privilege scalation|4- Escalación de privilegios]] — paso siguiente tras obtener acceso al host.
- [[_5- shells|5- Shells]] — establecer shell tras explotación.
- [[_4- Gestión de Bases de Datos desde Python|Python → 4- Bases de Datos]] — automatización Python sobre MySQL/MSSQL/Oracle.
- [[_7- Activie Directory|Active Directory]] — explotación combinada de SMB/RDP/WinRM en AD.
