---
tipo: teoria
tags: [cifrado, control-de-acceso, validacion-entrada, vulnerabilidades]
...
- [[../4- privilege scalation/1- privilege scalation basic|Privesc]] — control de acceso roto = vector de privesc.
- [[../6- Web/1- Protocolo HTTP|Protocolo HTTP]] — validación de entrada en aplicaciones web.
- [[../../7- Cifrado y Criptografía en Python/1- Cifrado y Descifrado de Contraseñas con Fernet en Python|Cifrado en Python]] — solución técnica al cifrado de información sensible.
