---
tipo: laboratorio
tags: [osint, spiderfoot, osint-framework, whatsmyname, smart, recon-ng, api-keys, builtwith, hunterio, intelligencex]
...
- ⬅️ Anterior: [[3- Reconocimiento activo vs. reconocimiento pasivo]]

## Relacionadas

- [[../../../01-Sistemas-Operativos/Windows/7- Activie Directory/1- OSINT|01 → OSINT en AD]] — base teórica del OSINT.
- [[../../../01-Sistemas-Operativos/Windows/7- Activie Directory/3- OSINT, Cómo encontrar información pública de cualquier persona|OSINT práctico]] — laboratorio similar enfocado a personas.
- [[../../5- Reconocimiento/2- Shodan/index|02 → Shodan]] — otra herramienta OSINT central.
- [[../../5- Reconocimiento/3- Geolocalización de IPs/index|02 → Geolocalización IPs]] — relacionado con ipapi.com mencionado.
- [[../../../06-Publicaciones-Linkedin/index|06 → LinkedIn]] — fuente OSINT clave para perfiles personales.
