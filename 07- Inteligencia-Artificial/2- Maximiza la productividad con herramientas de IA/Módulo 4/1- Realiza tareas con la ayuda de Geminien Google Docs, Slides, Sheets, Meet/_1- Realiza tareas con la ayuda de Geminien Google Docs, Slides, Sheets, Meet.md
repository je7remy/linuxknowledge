...
# 1- Realiza tareas con la ayuda de Geminien Google Docs, Slides, Sheets, Meet

Índice generado automáticamente para esta carpeta.
## Notas en esta carpeta

- [[1- Utiliza Gemini en Google Docs, Slides, Sheets, Meet y Gmail]]
- [[2- Utilice Gemini en el espacio de trabajo para ayudar a analizar el rendimiento empresarial]]
