...
- **[[Networking|Protocolo de Resolución de Direcciones (ARP)]]**: Un protocolo de red utilizado para determinar la dirección MAC del siguiente enrutador o dispositivo en la ruta
...
- **[[Malware|Adware]]**: Un tipo de software legítimo que a veces se utiliza para mostrar anuncios digitales en aplicaciones
...
- **[[Malware|Software antivirus]]**: Un programa de software utilizado para prevenir, detectar y eliminar malware y virus
- **Aplicación**: Un programa que realiza una tarea específica
- **[[Authentication|Token de interfaz de programación de aplicaciones (API)]]**: Un pequeño bloque de código cifrado que contiene información sobre un usuario
...
- **[[Authentication|Autenticación]]**: El proceso de verificar la identidad de alguien
...
- **[[Authentication|Autenticación básica]]**: La tecnología utilizada para establecer la solicitud de acceso de un usuario a un servidor
...
- **[[Authentication|Biometría]]**: Las características físicas únicas que pueden usarse para verificar la identidad de una persona
...
- **[[Malware|Botnet]]**: Una colección de computadoras infectadas por malware que están bajo el control de un único actor de amenazas, conocido como el "pastor de bots"
- **Notación de corchetes**: Los índices colocados entre corchetes
- **[[MOC - Forense Digital end-to-end|Cadena de custodia rota]]**: Inconsistencias en la recolección y registro de evidencia en la cadena de custodia
...
- **[[MOC - Python para Ciberseguridad|Función incorporada]]**: Una función que existe dentro de Python y puede llamarse directamente
...
- **[[MOC - Forense Digital end-to-end|Cadena de custodia]]**: El proceso de documentar la posesión y control de evidencia durante el ciclo de vida de un incidente
...
- **Sistema de Puntuación de Vulnerabilidades Comunes (CVSS)**: Un sistema de medición que puntúa la gravedad de una vulnerabilidad
- **[[Hacking Etico|Cumplimiento]]**: El proceso de adherirse a estándares internos y regulaciones externas
...
- **[[Malware|Virus informático]]**: Código malicioso escrito para interferir con las operaciones de la computadora y causar daño a datos y software
...
- **[[MOC - Web Pentesting OWASP|Cross-site scripting (XSS)]]**: Un ataque de inyección que inserta código en un sitio web o aplicación web vulnerable
- **Crowdsourcing**: La práctica de recopilar información utilizando la colaboración y la entrada del público
- **[[Cryptography|Ataque criptográfico]]**: Un ataque que afecta las formas seguras de comunicación entre un remitente y el destinatario previsto
...
- **[[Malware|Cryptojacking]]**: Una forma de malware que instala software para minar criptomonedas ilegalmente
...
- **[[Networking|Datos en tránsito]]**: Datos que viajan de un punto a otro
...
- **[[Authentication|Procesador de datos]]**: Una persona que es responsable de procesar datos en nombre del controlador de datos
...
- **[[Networking|Defensa en profundidad]]**: Un enfoque por capas para la gestión de vulnerabilidades que reduce el riesgo
- **[[Networking|Ataque de denegación de servicio (DoS)]]**: Un ataque que apunta a una red o servidor y lo inunda con tráfico de red
...
- **[[Cryptography|Certificado digital]]**: Un archivo que verifica la identidad del titular de una clave pública
...
- **[[Networking|Ataque de denegación de servicio distribuido (DDoS)]]**: Un tipo de ataque de denegación de servicio que utiliza múltiples dispositivos o servidores ubicados en diferentes lugares para inundar la red objetivo con tráfico no deseado
...
- **[[Networking|Sistema de Nombres de Dominio (DNS)]]**: Un protocolo de red que traduce nombres de dominio de internet en direcciones IP
...
- **[[VPN|Encapsulación]]**: Un proceso realizado por un servicio VPN que protege tus datos envolviendo datos sensibles en otros paquetes de datos
- **[[_7- Cifrado y Criptografía en Python|Cifrado]]**: El proceso de convertir datos de un formato legible a un formato codificado
- **[[SIEM EDR y SOC|Endpoint]]**: Cualquier dispositivo conectado en una red
- **[[SIEM EDR y SOC|Detección y respuesta de endpoints (EDR)]]**: Una aplicación que monitorea un endpoint en busca de actividad maliciosa
...
- **[[SIEM EDR y SOC|Falso negativo]]**: Un estado donde la presencia de una amenaza no es detectada
- **[[SIEM EDR y SOC|Falso positivo]]**: Una alerta que detecta incorrectamente la presencia de una amenaza
- **[[Malware|Malware sin archivo]]**: Malware que no necesita ser instalado por el usuario porque utiliza programas legítimos ya instalados para infectar una computadora
...
- **[[Networking|Cortafuegos]]**: Un dispositivo de seguridad de red que monitorea el tráfico hacia o desde una red
- **Datos de punto flotante**: Datos que consisten en un número con un punto decimal
- **[[_1- Bases de Datos|Clave foránea]]**: Una columna en una tabla que es una clave primaria en otra tabla
- **Servidor proxy de reenvío**: Un servidor que regula y restringe el acceso de una persona a internet
...
- **[[APT|Honeypot]]**: Un sistema o recurso creado como señuelo vulnerable a ataques con el propósito de atraer a posibles intrusos
- **[[SIEM EDR y SOC|Sistema de detección de intrusos basado en host (HIDS)]]**: Una aplicación que monitorea la actividad del host en el que está instalada
- **Hub**: Un dispositivo de red que transmite información a cada dispositivo en la red
- **[[Networking|Protocolo de Transferencia de Hipertexto (HTTP)]]**: Un protocolo de capa de aplicación que proporciona un método de comunicación entre clientes y servidores de sitios web
- **[[Networking|Protocolo de Transferencia de Hipertexto Seguro (HTTPS)]]**: Un protocolo de red que proporciona un método seguro de comunicación entre clientes y servidores de sitios web
...
- **[[MOC - Wireless Pentesting|IEEE 802.11 (Wi-Fi)]]**: Un conjunto de estándares que definen la comunicación para redes LAN inalámbricas
...
- **[[APT|Indicadores de ataque (IoA)]]**: La serie de eventos observados que indican un incidente en tiempo real
- **[[APT|Indicadores de compromiso (IoC)]]**: Evidencia observable que sugiere signos de un incidente de seguridad potencial
...
- **[[Networking|Protocolo de Mensajes de Control de Internet (ICMP)]]**: Un protocolo de internet utilizado por dispositivos para informar sobre errores de transmisión de datos a través de la red
...
- **[[Networking|Protocolo de Internet (IP)]]**: Un conjunto de estándares utilizados para enrutar y direccionar paquetes de datos mientras viajan entre dispositivos en una red
- **[[Networking|Dirección de Protocolo de Internet (IP)]]**: Una cadena única de caracteres que identifica la ubicación de un dispositivo en internet
- **Intérprete**: Un programa informático que traduce el código Python en instrucciones ejecutables línea por línea
- **[[SIEM EDR y SOC|Sistema de detección de intrusos (IDS)]]**: Una aplicación que monitorea la actividad del sistema y alerta sobre posibles intrusos
- **[[SIEM EDR y SOC|Sistema de prevención de intrusos (IPS)]]**: Una aplicación que monitorea la actividad del sistema para detectar actividad intrusiva y toma medidas para detenerla
- **[[Networking|Spoofing de IP]]**: Un ataque de red realizado cuando un atacante cambia la IP de origen de un paquete de datos para hacerse pasar por un sistema autorizado y obtener acceso a una red
...
- **[[Sintesis - Linux como sistema base del pentester|Kernel]]**: El componente del sistema operativo Linux que gestiona procesos y memoria
...
- **[[Sintesis - Linux como sistema base del pentester|Linux]]**: Un sistema operativo de código abierto
...
- **[[Malware|Cargador]]**: Código malicioso que se lanza después de que un usuario inicia un programa dropper
- **[[Networking|Red de Área Local (LAN)]]**: Una red que abarca áreas pequeñas como un edificio de oficinas, una escuela o un hogar
...
- **[[SIEM EDR y SOC|Análisis de registros]]**: El proceso de examinar registros para identificar eventos de interés
...
- **[[SIEM EDR y SOC|Gestión de registros]]**: El proceso de recolectar, almacenar, analizar y eliminar datos de registro
...
- **[[Malware|Malware]]**: Software diseñado para dañar dispositivos o redes
- **[[Malware|Infección de malware]]**: Un tipo de incidente que ocurre cuando un software malicioso diseñado para interrumpir un sistema se infiltra en las computadoras o redes de una organización
- **[[Networking|Dirección de Control de Acceso al Medio (MAC)]]**: Un identificador alfanumérico único asignado a cada dispositivo físico en una red
...
- **[[APT|MITRE]]**: Una colección de centros de investigación y desarrollo sin fines de lucro
...
- **[[Authentication|Autenticación multifactor (MFA)]]**: Una medida de seguridad que requiere que un usuario verifique su identidad de dos o más formas para acceder a un sistema o red

## N

- **nano**: Un editor de archivos de línea de comandos que está disponible por defecto en muchas distribuciones de Linux
- **[[SIEM EDR y SOC|Marco de Ciberseguridad NIST CSF]]**: Un marco voluntario que consiste en estándares, directrices y mejores prácticas para gestionar el riesgo de ciberseguridad
...
- **[[Networking|Red]]**: Un grupo de dispositivos conectados
- **[[SIEM EDR y SOC|Sistema de detección de intrusos basado en red (NIDS)]]**: Una aplicación que recolecta y monitorea el tráfico y los datos de red
- **[[Networking|Datos de red]]**: Los datos que se transmiten entre dispositivos en una red
- **[[Networking|Tarjeta de Interfaz de Red (NIC)]]**: Hardware que conecta computadoras a una red
- **[[Networking|Análisis de registros de red]]**: El proceso de examinar registros de red para identificar eventos de interés
- **[[Wireshark|Analizador de protocolos de red (sniffer de paquetes)]]**: Una herramienta diseñada para capturar y analizar el tráfico de datos dentro de una red
- **[[Networking|Protocolos de red]]**: Un conjunto de reglas utilizadas por dos o más dispositivos en una red para describir el orden de entrega y la estructura de los datos
- **[[Networking|Seguridad de red]]**: La práctica de mantener la infraestructura de red de una organización segura contra accesos no autorizados
- **[[Networking|Segmentación de red]]**: Una técnica de seguridad que divide la red en segmentos
- **[[Networking|Tráfico de red]]**: La cantidad de datos que se mueve a través de una red
...
- **[[OSINT|Inteligencia de código abierto (OSINT)]]**: La recolección y análisis de información de fuentes públicamente disponibles para generar inteligencia utilizable
- **[[Networking|Modelo de interconexión de sistemas abiertos (OSI)]]**: Un concepto estandarizado que describe las siete capas que las computadoras utilizan para comunicarse y enviar datos a través de la red
- **[[MOC - Web Pentesting OWASP|Proyecto de Seguridad de Aplicaciones Web Abiertas (OWASP)]]**: Una organización sin fines de lucro enfocada en mejorar la seguridad del software
...
- **[[MOC - Web Pentesting OWASP|OWASP Top 10]]**: Un documento de concienciación estándar reconocido globalmente que lista los 10 riesgos de seguridad más críticos para aplicaciones web
...
- **[[MOC - Forense Digital end-to-end|Captura de paquetes (P-cap)]]**: Un archivo que contiene paquetes de datos interceptados desde una interfaz o red
- **[[Networking|Sniffing de paquetes]]**: La práctica de capturar e inspeccionar paquetes de datos a través de una red
- **Parámetro (Python)**: Un objeto que se incluye en la definición de una función para su uso en esa función
- **[[Sintesis - Linux como sistema base del pentester|Parrot]]**: Una distribución de código abierto comúnmente utilizada para seguridad
- **[[Sintesis - Bash y Python en DFIR|Análisis sintáctico]]**: El proceso de convertir datos en un formato más legible
...
- **[[_1- Cracking|Ataque de contraseña]]**: Un intento de acceder a dispositivos, sistemas, redes o datos protegidos por contraseña
...
- **[[Pentesting|Prueba de penetración (pen test)]]**: Un ataque simulado que ayuda a identificar vulnerabilidades en sistemas, redes, sitios web, aplicaciones y procesos
...
- **[[OSINT|Phishing]]**: El uso de comunicaciones digitales para engañar a las personas para que revelen datos sensibles o implementen software malicioso
- **[[OSINT|Kit de phishing]]**: Una colección de herramientas de software necesarias para lanzar una campaña de phishing
...
- **[[Networking|Ping de la muerte]]**: Un tipo de ataque DoS causado cuando un hacker envía un paquete ICMP sobredimensionado mayor a 64KB a un sistema
...
- **[[Networking|Puerto]]**: Una ubicación basada en software que organiza el envío y recepción de datos entre dispositivos en una red
- **[[Networking|Filtrado de puertos]]**: Una función de cortafuegos que bloquea o permite ciertos números de puerto para limitar la comunicación no deseada
...
- **[[_1- Bases de Datos|Clave primaria]]**: Una columna donde cada fila tiene una entrada única
- **[[Hacking Etico|Principio de privilegio mínimo]]**: El concepto de otorgar solo el acceso y autorización mínimos requeridos para completar una tarea o función
...
- **[[Networking|Servidor proxy]]**: Un servidor que cumple con las solicitudes de sus clientes reenviándolas a otros servidores
...
- **[[Cryptography|Infraestructura de clave pública (PKI)]]**: Un marco de cifrado que asegura el intercambio de información en línea
...
- **Ataque XSS reflejado**: Una instancia cuando un script malicioso se envía a un servidor y se activa durante la respuesta del servidor
...
- **Guía de estilo**: Un manual que informa la escritura, formato y diseño de documentos
...
- **Aprovisionamiento de usuarios**: El proceso de crear y mantener la identidad digital de un usuario
