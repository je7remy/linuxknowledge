...
- **No existe un estándar universal:** Cada empresa define sus propias reglas. Lo que funciona para una, no funciona para otra.
    
- **¿Qué es la Política de Escalamiento?** Es el documento oficial que establece **a quién se debe notificar** y **cómo se debe gestionar** un incidente.
    
- **Prepara para desafíos:** El video da un gran ejemplo: ¿Qué haces si tu supervisor inmediato está fuera de la oficina? Una buena política define la cadena de mando (a quién contactar _después_) para que el incidente nunca quede sin reportar.
