...
Todos los incidentes de Seguridad deben tener la misma prioridad.
...
Recientemente ha sido contratado como analista de ciberseguridad para una organización de suministros de oficina. ¿Qué incidente puede tener un mayor impacto en las operaciones de la organización?

- La red Wi-Fi de invitados de la organización no funciona
    
- ✅ **La red de fabricación de la organización se ve comprometida**
...
Rellene el espacio en blanco: Un(a) _____ es un conjunto de acciones que describe a quién se debe notificar cuando se produce una alerta de incidente y cómo se debe gestionar dicho incidente.
...
¿Qué tipo de clasificación de incidentes se produce cuando un empleado infringe la política de uso aceptable de una organización?
